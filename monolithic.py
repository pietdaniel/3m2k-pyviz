...
class Label():
	def __init__(self,size=300):
		...
		self.font3 = pygame.font.SysFont("", 290)
		self.font4 = pygame.font.SysFont("", 320)
		self.wlabel = self.font.render("3M2K", 1, (255,255,255))
		self.blabel = self.font.render("3M2K", 1, (0,0,0))
		self.label3 = self.font3.render("3M2K", 1, (255,0,250))
		self.label4 = self.font3.render("3M2K", 1, (0,255,250))
		self.label5 = self.font4.render("3M2K", 1, (5,0,0))
	def brand(self):
		scr.blit(self.blabel, (654, 442))
		scr.blit(self.wlabel, (654, 440))
	def dbrand(self):
		scr.blit(self.label5, (640, 440))
		scr.blit(self.blabel, (654, 442))
		scr.blit(self.wlabel, (654, 440))
	def alt_draw(self,l):
		scr.blit(self.label3, (650, 441+l/5000))
		scr.blit(self.label4, (668, 441+l/5000))
		scr.blit(self.blabel, (654, 442+l/5000))
		scr.blit(self.wlabel, (654, 440+l/5000))
	def rol_data(self,p,q,delta0,delta1,myspf):
		scr.blit(self.font2.render(str(round(q,3)), 1, (255,255,255)), (5, 5))
		scr.blit(self.font2.render(str(round(p,3)), 1, (255,255,255)), (5, 20))
		scr.blit(self.font2.render(str(round(p-q,3)), 1, (255,255,255)), (5, 35))
		scr.blit(self.font2.render(str(round(delta1-delta0,3)), 1, (255,255,255)), (5, 50))
		scr.blit(self.font2.render(str(round(myspf,3)), 1, (255,255,255)), (5, 65))
...
# m_v13 | we must believe in god (wmbg)
def wmbig():
	play_song("god.wav")
	logo = Label()
	ctr=0
...
# m_v14 | theta log n lgn
def lgn():
	play_song("theta.flac")
	logo=Label()
	ctr=0
	loop = 0
...
# m_v15 | faith and confidence (fnc)
def fnc():
	play_song("faith.wav")
	logo=Label()
	loop = 0
			...
			if (abs(p-q)>1 and ctr%7==0):
				...
				if (ctr%57==0):
					if ((p-q)<-0.1):
						...
						if (abs(delta1-delta0)<.1):
							myspf+=1
			logo.rol_data(p,q,delta0,delta1,myspf)
...
# m_v7 | tainted and consistent (tnc)
def tnc():
	play_song("taint.wav")
	logo=Label()
	loop = 0
...
# m_v9 | no value (nvalue)
def nvalue():
	play_song("novalue.flac")
	logo = Label()
	loop = 0
	ctr=0
